...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="container">
            <form action="{{route('role.update',$editGroup['id'])}}" method="post">@csrf
                <div class="main-body">
                    <div class="row">
                        <?php
                                                    // echo "<pre>"; print_r($groupModule); exit;
                                                ?>
                        <div class="col-lg-12">
                            <div class="card">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 mt-4">
                                            ...
                                            <select class="single-select" name="txtaccess[]" id="e1" multiple="multiple"
                                                ...
                                                <option value="{{$key}}" @if(in_array($data['module_page'],$mergeArr))
                                                    selected="" @endif>{{$data['module_name']}}</option>
                                                @endforeach
                                            </select>
