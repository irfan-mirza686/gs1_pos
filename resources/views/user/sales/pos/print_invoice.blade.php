...
<table width="90%" cellpadding="10" class="tableS" cellspacing="10" style="font-family: 'Open Sans', 'Martel Sans', sans-serif; font-size: 11px !important;margin-left:20px;">
  <thead>
   ...
   <tr>
    ...
    <td colspan="5"  class="noborder" align="right"><strong>Time:</strong> {{@$getInvoiceData->time}}  </td>
  </tr>
  <tr>
    <td class="noborder" colspan="3"><strong>Invoice No:</strong> {{@$getInvoiceData->invoice_no}}</td>
   <td colspan="5" class="noborder" style="text-align: right;"><strong>Customer:</strong> {{@$getInvoiceData->customerName}}
    </td>
  </tr>
 ...
 <tr>
  ...
  <td width="30"><strong>Desc</strong></td>
  <td id="kitchenph" width="100"><strong>Price</strong></td>
  <td width="15"><strong>Qty</strong></td>
  <td width="15"><strong>Disc</strong></td>
  <td width="15"><strong>Vat%</strong></td>
...
<?php
$counter = 0;
$addons = unserialize($getInvoiceData->pos_addons);
...
<tr>
  ...
  <td width="100">{{$print['barcode']}}</td>
  <td class="kitchen" width="50">{{$print['description']}}</td>
  <td class="kitchen" width="50">{{$print['price']}}</td>
  <td class="kitchen" width="50">{{$print['quantity']}}</td>
  <td class="kitchen" width="50">{{$print['discount']}}</td>
  <td class="kitchen" width="50">{{$print['vat']}}</td>

  <td class="kitchen" width="50" style="text-align: right;">{{number_format($print['single_total'])}}</td>
...
<table style="page-break-inside:avoid;font-family: 'Open Sans', 'Martel Sans', sans-serif; font-size: 10.5px !important;margin-left:20px" width="90%" cellpadding="5" class="tableS kitchen" cellspacing="5" id="kitchen">
 ...
 <tr>
  ...
  <td><strong></strong></td>
  <td class="grandtotalFont"style="text-align: right;"><strong>{{number_format($getInvoiceData->totalAmount)}}</strong></td>
</tr>
...
<tr>
  <td colspan="3"><strong>Tender Amount:</strong></td>
  <td><strong></strong></td>
...
<tr>
  <td colspan="5" align="center">
    <strong><?php echo DNS2D::getBarcodeHTML(@$getInvoiceData->invoice_no, 'QRCODE', 5,5);?> </strong><br>
...
<tr>
  <td colspan="5" align="center">
    <strong>Thanks for visiting Us, +920330000000000</strong><br>
