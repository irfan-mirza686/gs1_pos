                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6 gs1" style="display:none;">
                                            ...
                                            <input type="text" class="form-control" id="producturl" name="product_url"
                                                placeholder="Product URL" value="{{ $editProduct['BrandName'] ?? old('BrandName')}}">
                                        </div>
                                        @endif
                                        <div class="mb-3 col-md-6">
                                    ...
                                    @if($type=='gs1_product')
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="single-select form-control" name="BrandNameAr" id="BrandNameAr">
                                                <option disabled selected>-select-</option>
                                                @foreach($productData['brandsData'] as $brand)
                                                <option value="{{$brand['name_ar']}}" {{($editProduct['BrandNameAr']==$brand['name_ar'])?'selected':''}}>{{$brand['name_ar']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @endif
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="single-select form-control" name="countrySale" id="countrySale">
                                                <option disabled selected>Choose...</option>
                                                @foreach($productData['countryOfSaleData'] as $country)
                                                <option value="{{$country['Alpha3']}}" {{($editProduct['Origin']==$country['Alpha3'])?'selected':''}}>{{$country['country_name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <select class="single-select form-control" name="prod_lang" id="prod_lang">
                                                ...
                                                <option value="{{$lang['language_name']}}" {{($editProduct['prod_lang']==$lang['language_name'])?'selected':''}}>{{$lang['language_name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="single-select form-control" name="ProductType" id="gtin_type">
                                                ...
                                                <option value="{{$type['name']}}" {{($editProduct['ProductType']==$type['name'])?'selected':''}}>{{$type['name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="single-select form-control" name="PackagingType" id="PackagingType">
                                                ...
                                                <option value="{{$pkg_type['name']}}" {{($editProduct['PackagingType']==$pkg_type['name'])?'selected':''}}>{{$pkg_type['name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="single-select form-control appendGpc" name="gpc" id="appendGpc">
                                                <option disabled selected>Choose...</option>
                                                <option value="{{$editProduct['gpc']}}" selected>{{$editProduct['gpc']}}</option>
                                            </select>
                                        </div>
