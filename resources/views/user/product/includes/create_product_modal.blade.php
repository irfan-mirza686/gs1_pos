            ...
            <form id="addProductForm" action="">
                <div class="modal-body">
                    <div>
                        ...
                        <input class="form-control form-control-sm mb-3" name="name" type="text"
                            placeholder="Enter Product Name" aria-label=".form-control-sm example">
                    </div>

                    <div>
                        <label for="brand" class="form-label">Brand Name</label>
                        <input class="form-control form-control-sm mb-3" name="brand" type="text"
                            placeholder="Enter Brand Name" aria-label=".form-control-sm example">
                    </div>

                    <div class="">
                        @include('user.product.includes.append_units')
                    </div>
                    <div>
