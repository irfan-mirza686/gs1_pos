<div class="modal fade" id="brandModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="addBrandForm" action="">
                <div class="modal-body">
                <input type="hidden" name="brand_id">
                    <label for="exampleDataList" class="form-label">Brand Name</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-block rounded-0" style="width:80% !important; margin: auto; background-color: black; color: white;"><span id="spinner" class="" role="status" aria-hidden="true"></span>&nbsp;&nbsp;<span class="saveBrandBtn">Save</span></button>
                </div>
            </form>
